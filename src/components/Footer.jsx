...
const Footer = () => {
  return (
    <footer className="bg-[#032541] text-white py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col gap-10 md:flex-row md:justify-between">

  
        <div className="flex flex-col items-start gap-6 md:w-1/4">
          <img src={Img1} alt="logo" className="w-[100px] sm:w-[120px]" />
          <button className="bg-white text-cyan-600 font-bold px-5 py-2 rounded-md hover:bg-gray-100 transition">
            JOIN THE COMMUNITY
          </button>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-sm md:w-3/4">
