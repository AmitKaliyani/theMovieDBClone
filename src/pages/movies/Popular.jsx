...
const Popular = () => {
  ...
  const fetchMovies = async (reset = false) => {
    ...
    let url = `https://api.themoviedb.org/3/discover/movie?api_key=37950764c84c26ca876141ed8bfeb702&sort_by=${sort_by}&page=${reset ? 1 : page}`;
    ...
    <div className="bg-white text-black min-h-screen p-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
        ...
        <div className="w-full lg:w-1/4">
          <Sidebar onApplyFilters={(newFilters) => {
