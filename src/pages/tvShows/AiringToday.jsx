...
const AiringToday = () => {
  ...
  const fetchMovies = async (reset = false) => {
    ...
    let url = `https://api.themoviedb.org/3/tv/airing_today?api_key=37950764c84c26ca876141ed8bfeb702&page=${reset ? 1 : page}`;
  ...
  return (
    <div className="bg-white text-black min-h-screen p-4">
      <h1 className="text-2xl font-bold mb-4">TV Shows Airing Today</h1>
