...
const TvDetails = () => {
  ...
  useEffect(() => {
    const fetchTv = async () => {
      try {
        const [tvRes, videoRes, castRes] = await Promise.all([
    ...
    <div className="p-4 md:p-8 bg-gray-100 min-h-screen">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row  gap-6 ">
        <img
          ...
          alt={tv.name}
          className="w-full sm:h-[500px] h-[350px]   md:w-1/3 rounded-xl shadow-lg"
        />
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 text-sm mt-2 italic">{tv.tagline}</p>
          ...
          <p className="mt-6 text-gray-800 leading-relaxed">{tv.overview}</p>
